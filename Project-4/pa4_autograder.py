    ...
    for testfile in sorted(os.listdir(input_dir)):
        ...
        for resultfile in sorted(os.listdir(output_dir)):
            ...
            if resultfile[len(resultfile)-5] == "1" :
                try:
                    run_command("./%s 512 assoc:1 fifo 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                ...
                try:
                    run_command("./%s 512 assoc:1 lru 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                ...
                try:
                    run_command("./%s 256 assoc:64 lru 4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:64 lru 8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:1 lru 4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:32 fifo 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
...
def grade_second(dirname):
    ...
    for testfile in sorted(os.listdir(input_dir)):
        ...
        for resultfile in sorted(os.listdir(output_dir)):
            ...
            if resultfile[len(resultfile)-5] == "1" :
                try:
                    run_command("./%s 512 assoc:1 fifo 16 1024 assoc:1 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:1 lru 16 512 assoc:2 lru %s  > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:4 fifo 8 512 assoc:64 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:2 lru 4 2048 assoc:1 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 256 assoc:64 lru 4 512 assoc:4 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:64 lru 8 512 assoc:1 lru %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:1 lru 4 512 assoc:4 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 2048 assoc:8 fifo 4 256 assoc:64 lru %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:32 fifo 16 1024 assoc:1 fifo %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    print "myScore is ", myscore
...
#            	print "Deleting the directory obj_temp."
    ...
    print "Your final score for PA4 is " , total , "/ 100.0"
